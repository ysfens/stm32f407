...
uint16_t Read_ADC(void)		// CONFIGURATION FOR GETTING ADC VALUES
...
int main()
{
	uint8_t ADC_Data; //it will safe the 8 bit data inside of itself
	...
	//CLOCK ENABLE-DISABLE CONFIGURATION
	...
	GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_AN;	// choose "AN" for analog input
	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
